# Arandu 0.1.0-rc.5 — relatório de promoção
...
cargo run --locked -p xtask -- check-release-contract v0.1.0-rc.5
git tag -a v0.1.0-rc.5 -m "Arandu 0.1.0-rc.5"
...
- [ ] Artifact `rc-evidence-v0.1.0-rc.5` preservado.
